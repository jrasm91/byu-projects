    ...
    extends Thread
{
	 ...
	 */
    public synchronized Object sendSynchronous(GlobalObjectId globalObjectId, Command command)
    {
	 ...
	 */
    public synchronized void sendASynchronous(GlobalObjectId globalObjectId, Command command) {
        ObjectOutputStream oos = null;
        ObjectInputStream ois = null;
        try {
          //open a socket connection
    ...
    public PortNumber getMyPortNumber(){
    	return myGlobalObjectId.getPortNumber();
    }
}
